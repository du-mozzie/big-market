...
import com.mozzie.domain.strategy.service.armory.IStrategyArmory;
import com.mozzie.domain.strategy.service.rule.chain.impl.RuleWeightLogicChain;
import com.mozzie.domain.strategy.service.rule.tree.impl.RuleLockLogicTreeNode;
...
/**
 * @author : mozzie
 * @description : 抽奖测试, 库存扣减redis, MySQL异步同步库存
 * @date : 2025/2/24 21:23
 */
@Slf4j
@RunWith(SpringRunner.class)
@SpringBootTest
public class RaffleStrategyTest3 {
